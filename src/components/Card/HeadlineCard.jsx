			...
			<div className="max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-5 ">
				...
				<div className="rounded-xl relative">
					...
					<div className="absolute w-full h-full bg-black/40 rounded-xl text-white">
						...
						<p className="px-2">Most favourable</p>
						<button className="border-white bg-white text-black mx-2 absolute bottom-4 hover:bg-orange-600">
							Order Now
						</button>
					</div>
					<img
				...
				<div className="rounded-xl relative">
					...
					<div className="absolute w-full h-full bg-black/40 rounded-xl text-white">
						...
						<p className="px-2">By Costumers</p>
						<button className="border-white bg-white text-black mx-2 absolute bottom-4 hover:bg-orange-600">
							Order Now
						</button>
					</div>
